...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            {!! Form::open(['url' => action('Admin\BankController@update', $bank), 'class' => 'form-horizontal', 'method' => 'PUT']) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text('id', $bank->id, ['class' => 'form-control', 'readonly' => 'yes']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ Form::hasError('name') }}">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text('name', $bank->name, ['class' => 'form-control', 'maxlength' => 255]) !!}
                            {!! Form::errorMsg('name') !!}
                        </div>
                    </div>
