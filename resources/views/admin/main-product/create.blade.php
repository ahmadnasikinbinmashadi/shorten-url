...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            {!! Form::open(['url' => action('Admin\MainProductController@store'),'id' => 'model-soal-form', 'class' => 'form-horizontal','autocomplete' => 'off']) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text('product_id', $product_id, ['class' => 'form-control', 'readonly' => 'yes']) !!}
                        </div>
                    </div>
...
@section('scripts')
    {!! JsValidator::formRequest('App\Modules\Backend\Http\Requests\MainProductRequest') !!}
@endsection