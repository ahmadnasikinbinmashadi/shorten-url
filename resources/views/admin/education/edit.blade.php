...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            {!! Form::open(['route' => ['admin.jenjang.update',$education->id], 'method' => 'POST','id' => 'education-form', 'class' => 'form-horizontal','autocomplete' => 'off']) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text('id', $education->id, ['class' => 'form-control', 'readonly' => 'yes']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text('education_name', $education->education_name, ['class' => 'form-control', 'maxlength' => 255]) !!}
                        </div>
                    </div>
