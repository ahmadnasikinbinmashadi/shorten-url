...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            {!! Form::open(['url' => action('Admin\KatBukuController@store'),'id' => 'kateg-buku-form', 'class' => 'form-horizontal','autocomplete' => 'off']) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text('kateg_buku_id', $kateg_buku_id, ['class' => 'form-control', 'readonly' => 'yes']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ Form::hasError('parent_id') }}">
                        ...
                        <div class="col-sm-5">
                            {!! Form::select('parent_id', $parents, null, ['class' => 'form-control select2 parent_field', 'data-index' => $index]) !!}
...
@section('scripts')
    ...
    @include('backend::admin.kategori-buku.scripts.create_script')
@endsection