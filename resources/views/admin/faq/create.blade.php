...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            {!! Form::open(['url' => action('Admin\FaqController@store'),'id' => 'faq-form', 'class' => 'form-horizontal','autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                <div class="box-body">
                    ...
                    <div class="form-group{{ Form::hasError('faq_group_id') }}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::select('faq_group_id', $groups, null, ['class' => 'form-control']) !!}
