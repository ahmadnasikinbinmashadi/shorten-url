...
@section('page-header', trans('backend::app.label.master_kelas'))
...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{!! action('Admin\KelasController@index') !!}">{!! trans('backend::app.label.master_kelas') !!}</a></li>
    </ol>
@endsection
...
@section('content')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <table id="kelas-table" class="table table-bordered table-nowrap table-striped table-colored table-primary" width="100%" data-tables="true">
                <thead>
                    <tr>
                        <th class="center-align">{!! trans('backend::app.table.head.title.kelas.id') !!}</th>
                        <th class="center-align">{!! trans('backend::app.table.head.title.kelas.name') !!}</th>
                        <th class="center-align">{!! trans('backend::app.table.head.title.kelas.jenjang') !!}</th>
                        ...
                        <th class="center-align">{!! trans('backend::app.table.head.title.status_delete') !!}</th>
...
@section('scripts')
    @include('backend::admin.kelas.scripts.script')
